...
@GraphQLName("VersionsCleanerMutation")
@GraphQLDescription("Versions Cleaner mutations")
public class VersionsCleanerMutation {

    private static final Logger LOGGER = LoggerFactory.getLogger(VersionsCleanerMutation.class);
    ...
    @GraphQLField
    @GraphQLName("createTestVersions")
    ...
    @GraphQLRequiresPermission("versionsCleanerAdmin")
    public String createTestVersions(
            @GraphQLName("name")
    ...
    @GraphQLRequiresPermission("versionsCleanerAdmin")
    public Boolean setStartupDelay(
            @GraphQLName("delayMs")
